...
import { useAuth, useApi } from '../../Hooks/CustomHooks';
...
const Register = () => {
  const { CreatUser, updateUser, googleLogin } = useAuth();
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      await updateUser({ displayName: name.value, photoURL: photoURL.value });
      ...
      const { error: apiError } = await makeRequest('post', '/users', userData);
